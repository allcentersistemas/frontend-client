  ...
  return (
    <div
      className={cn(
        ...
        isPlanillaSplit ? 'lg:grid-cols-1' : 'lg:grid-cols-[280px_1fr]',
    ...
    >
      ...
      <header className="fixed inset-x-0 top-0 z-40 flex min-h-14 items-center justify-between gap-3 border-b border-slate-200/80 bg-white/85 px-4 py-3 backdrop-blur-xl dark:border-white/[0.08] dark:bg-slate-950/80 lg:hidden">
        ...
        <p className="truncate text-sm font-semibold text-slate-900 dark:text-white">
          {isPlanillaSplit ? 'Detalle de orden' : 'Portal cliente'}
        </p>
      </header>
      ...
      <aside
        className={cn(
          ...
          isPlanillaSplit && 'hidden lg:hidden',
        )}
      >
      ...
      <main className={cn('min-w-0 pt-[3.75rem] lg:col-start-2 lg:pt-0', isPlanillaSplit && 'lg:col-start-1')}>
        <div className={cn('app-shell-page', isPlanillaSplit && 'app-shell-page--split')}>
